...
namespace Jogo_da_memória
{
    public partial class FormNivelFacil : Form
    {
        ...
        private void FormNivelFacil_Load(object sender, EventArgs e)
        {
            ...
            foreach (Control x in this.Controls)
                if (x is Button && x.Tag.ToString() != "o")
                    x.BackgroundImage = Properties.Resources.trasCarros;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string s = "car" + cartaAtual.Tag.ToString();
            object o = Properties.Resources.ResourceManager.GetObject(s);
        ...
        private void CompararCartas(Button cAnterior, Button cAtual)
        {
            ...
            if (cAnterior == cAtual)
            {
                ...
                nCliques = 0;
                cAtual.BackgroundImage = Properties.Resources.trasCarros;
            }
            else
            {
                ...
                {
                    nCliques = 0;
                    cAnterior.BackgroundImage = Properties.Resources.trasCarros;
                    cAtual.BackgroundImage = Properties.Resources.trasCarros;
                }
            }
        }
        ...
        private void ButaoJogarDeNovo2_Click(object sender, EventArgs e)
        {
        ...
        private void ButaoJogarDeNovo2_Click_1(object sender, EventArgs e)
        {
            this.Close();
        }
